...
namespace package_delivery_simulator;

/// <summary>
/// A konzolos alkalmazás belépési pontja.
/// Itt történik az adatbázis inicializálása, az algoritmusok futtatása és a szimuláció indítása.
/// </summary>
public class Program
{
    /// <summary>
    /// Aszinkron belépési pont, amely lehetővé teszi az await használatát.
    /// </summary>
